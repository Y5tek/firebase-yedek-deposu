...
// Function to add IDs to initial data
const addIdToData = (data)=>{
    return data.map((item, index)=>({
            ...item,
            id: `initial-${index}` // Simple unique ID generation for initial data
        }));
};
function SeriTadilatOnayPage() {
    // Use initialApprovalData from the shared file, adding IDs
    const [approvalData, setApprovalData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(addIdToData(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$approval$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialApprovalData"]));
    ...
    const [isUploading, setIsUploading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false); // State for file upload processing
    ...
    const fileInputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null); // Ref for file input
    const nextId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$approval$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialApprovalData"].length); // Ref to generate unique IDs for new entries
    ...
    const onSubmit = (data)=>{
        ...
        // Add the new data with a unique ID
        const newDataEntry = {
            ...data,
            id: `new-${nextId.current++}` // Generate unique ID
        };
    ...
    // TODO: Update persisted data if applicable
    };
    ...
    const handleFileChange = (event)=>{
        ...
        reader.onload = (e)=>{
            ...
            try {
                ...
                // --- Header Validation ---
                const headerRow = jsonData[0].map((h)=>h?.trim() || ''); // Get header row and trim
                ...
                // Create a map from actual header (lowercase) to index for data retrieval
                ...
                const newData = []; // Changed to ApprovalDataWithId
                const validationErrors = [];
                let duplicateCount = 0;
                // Start from row 1 (index 1) to skip header
                for(let i = 1; i < jsonData.length; i++){
                    const row = jsonData[i];
                    // Check if the row is empty or contains only whitespace before processing
                    if (!row || row.every((cell)=>!cell || String(cell).trim() === '')) {
                        continue; // Skip empty rows
                    }
                    // Construct data object based on header map
                    const rowData = {
                    ...
                    if (!validationResult.success) {
                        ...
                        // Check for duplicates within the current file and existing data
                        ...
                        if (!isDuplicate) {
                            // Add validated data with a new unique ID
                            newData.push({
                ...
                if (validationErrors.length > 0) {
                    ...
                    // This case might happen if the file had only headers or only empty rows after headers
                    toast({
                        title: "Veri Yüklenmedi",
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableBody"], {
                                            children: approvalData.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableRow"], {
                                                ...
                                                lineNumber: 559,
                                                columnNumber: 22
                                            }, this) : // Sort data alphabetically by Marka, then Tip Onay No for consistency
                                            [
                                                ...approvalData
                                            ].sort((a, b)=>{
                                                if (a.marka.toLowerCase() < b.marka.toLowerCase()) return -1;
                                                if (a.marka.toLowerCase() > b.marka.toLowerCase()) return 1;
                                                if (a.tipOnayNo.toLowerCase() < b.tipOnayNo.toLowerCase()) return -1; // Sort by Tip Onay No
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ad7e5313._.js.map